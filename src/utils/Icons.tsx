/**
 * Central repository for all Lucide-React icons used throughout the application.
 * All icons are pre-styled with Tailwind CSS classes for consistency.
 */
...
/**
 * Weather condition icons used in the forecast and current weather displays
 */
...
/**
 * General UI icons for navigation, search, and external links
 */
...
/**
 * Icons representing specific weather metrics (wind, humidity, visibility, etc.)
 */
